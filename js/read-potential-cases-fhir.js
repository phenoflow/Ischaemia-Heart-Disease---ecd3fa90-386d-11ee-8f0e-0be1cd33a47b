...
(async () => {
  ...
  await fs.writeFile("ischaemia-heart-disease-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("ischaemia-heart-disease-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
